            ...
            <div className="relative h-screen flex items-center justify-center">
              <div className="container mx-auto px-4">
                ...
                <AnimatePresence>
                  {showScrollIndicator && (
                    <motion.div 
                      className="absolute left-0 right-0 mx-auto bottom-10 mt-8"
                      initial={{ opacity: 0, y: 20 }}
                      animate={{ opacity: 1, y: 0 }}
                      exit={{ opacity: 0, y: 10 }}
                    ...
                    >
                      <motion.button
                        ...
                        className="inline-flex flex-col items-center justify-center w-full text-gray-500 dark:text-white/70 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors"
                      ...
                      >
                        <span className="text-center font-medium mb-2">Learn More</span>
              ...
              <div className="container mx-auto px-6">
                <div className="flex flex-col md:flex-row justify-between items-center gap-2">
                  <div className="mb-2 md:mb-0">
                    <h2 className="text-base font-bold text-gray-800 dark:text-white">High-Low Hustle</h2>
                    <p className="text-gray-600 dark:text-gray-400 mt-0.5 text-xs">A fun game of search volume comparisons</p>
                  </div>
