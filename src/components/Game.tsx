    ...
    <div className="min-h-screen p-2 sm:p-4 bg-gradient-to-br from-gray-100 to-white dark:from-gray-900 dark:to-gray-800">
      <div className="max-w-6xl mx-auto relative">
        ...
        <div className="relative bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl rounded-2xl p-4 sm:p-6 shadow-xl border border-white/20 dark:border-white/10">
          ...
          {!gameOver ? (
            <div className="flex justify-between items-center mb-8 mt-2 relative z-10 pl-20">
              <div className="bg-gradient-to-r from-indigo-600/20 via-purple-600/20 to-pink-600/20 dark:from-indigo-600/30 dark:via-purple-600/30 dark:to-pink-600/30 rounded-xl backdrop-blur-sm p-3 border border-white/20 dark:border-gray-700/30 flex items-center gap-3">
                <div className="flex gap-1">
                  ...
                  {score > 5 && (
                    <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent font-bold ml-1">+{score - 5}</span>
                  )}
                </div>
            ...
            <div className="flex justify-center items-center gap-4 mb-4 mt-16 pt-6">
              <div className="bg-gradient-to-r from-indigo-600/20 via-purple-600/20 to-pink-600/20 dark:from-indigo-600/30 dark:via-purple-600/30 dark:to-pink-600/30 rounded-xl backdrop-blur-sm p-3 border border-white/20 dark:border-gray-700/30 flex items-center gap-3">
                <div className="flex gap-1">
                  {[...Array(Math.min(5, score))].map((_, i) => (
                    <svg
                      key={`game-over-star-${i}`}
                      className="w-6 h-6 text-yellow-400"
                      fill="currentColor"
                      viewBox="0 0 20 20"
                    >
